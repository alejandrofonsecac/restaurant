    ...
    <div className="food-items">
        ...
        <div className={style.foodItem}>
            <div className={style.informationItem}>
                ...
                <p className={style.ingredients}>Bacon, ovos, queijo parmesão и pimenta do reino</p>
                <div className={style.shoppingInfo}>
                    <button>Adicionar +</button>
                    <p id='preco'></p>
                </div>
    ...
    <div className="food-items">
        ...
        <div className={style.foodItem}>
            <div className={style.informationItem}>
                ...
                <p className={style.ingredients}>Arroz blanco, batata palha e frango em molho cremoso</p>
                <div className={style.shoppingInfo}>
                    <button>Adicionar +</button>
                    <p id='preco'></p>
                </div>
